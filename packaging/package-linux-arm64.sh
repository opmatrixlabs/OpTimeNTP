...
build_dir=${1:-"$repository_dir/cmake-build-release-wks-pi5"}
...
case "$machine_arch" in
  aarch64|arm64) ;;
  *)
    echo "Linux ARM64 packaging must run on an ARM64 host; detected: $machine_arch" >&2
    exit 2
    ;;
esac

qt_dir=${OPTIME_QT_DIR:-/home/akbailey/Qt/6.10.3/gcc_arm64}
